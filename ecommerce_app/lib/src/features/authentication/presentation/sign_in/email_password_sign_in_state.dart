...
class EmailPasswordSignInState with EmailAndPasswordValidators {
  ...
  // Note: when creating data classes, implementing == and hashCode is very important,
  // because many state management packages such as Riverpod, Bloc, Redux
  // rely on this in order to know if two instances of a class are the same.
